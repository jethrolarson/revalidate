...
(function($) {
	...
	window.FieldValidator.prototype = $.extend(window.FieldValidator.prototype, {
		disabled: false,
		...
		bindEvents: function() {
			...
			.live(this.settings.revalidateOn, function() {
				$(this).hasClass('invalid') && that.validate(this);
				return true;
			});
		}
	});
	...
	// -------------------------------
	window.FormValidator = function(selector, settings) {
	...
	window.FormValidator.prototype = $.extend(window.FormValidator.prototype, {
		// Adds a FieldValidator instance to `this.fieldValidators`
		addFieldValidator: function(selector, settings) {
			this.fieldValidators.push(new window.FieldValidator(selector,settings));
			return this;
		},
	...
	// if included. I've tried to use a subset of the same api.
